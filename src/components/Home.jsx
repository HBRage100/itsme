    ...
    <>
      ...
      >
        <div className="max-md:order-2 md:pt-32 pt-16">
          ...
          <div className="flex items-center text-studio-700">
          ...
          {/* button */}
          <div className="lg:inline-flex flex-wrap items-center justify-center flex gap-5 pt-4">
            <Link
              activeClass="active"
              to="contact"
              spy={true}
          ...
          {/* Follow button */}
          <div className="lg:pt-16 pt-8 flex items-center">
            <p
        ...
        <div className="relative my-auto max-md:order-1 max-md:pt-32 md:pt-10 max-sm:pt-24">
          <div className="bg-white shadow-2xl lg:mt-16 lg:mx-56 max-md:mx-40 md:mx-32 max-sm:mx-16 w-24 h-24 flex justify-center items-center rounded-2xl">
            <img src={figma} alt="VS Code" className="w-16 h-16" />
          </div>
          <div className="bg-white shadow-2xl lg:ml-[70%] lg:-mt-10 ml-[70%] -mt-20 w-20 h-20 absolute flex justify-center items-center rounded-2xl">
            <img src={fireFox} alt="VS Code" className="w-12 h-12" />
          </div>
          <div className="bg-white shadow-2xl lg:mx-40 max-md:mx-20 md:mx-16 max-sm:mx-2 mt-16 w-20 h-20 absolute flex justify-center items-center rounded-2xl">
            <img src={tailWind} alt="VS Code" className="w-12 h-12" />
          </div>
          <div className="bg-white shadow-2xl mx-auto mt-4 lg:w-40 lg:h-40 w-32 h-32 flex justify-center items-center rounded-2xl">
            <img
              src={vsCode}
              alt="VS Code"
          ...
          <div className="bg-white shadow-2xl lg:mx-48 max-md:mx-28 md:mx-24 max-sm:mx-6 mt-4 w-28 h-28 flex justify-center items-center rounded-2xl">
            <img src={reactIcon} alt="VS Code" className="w-22 h-22" />
          </div>
          <div className="bg-white shadow-2xl lg:ml-[64%] max-md:ml-[75%] md:ml-[65%] -mt-60 w-14 h-14 absolute flex justify-center items-center rounded-2xl">
            <img src={gitHub} alt="VS Code" className="w-10 h-10" />
          </div>
          <div className="bg-white shadow-2xl ml-[50%] -mt-24 w-24 h-24 absolute flex justify-center items-center rounded-2xl">
